...
const mockClientDetails: Record<string, ClientDetails> = {
  '1': {
    ...
    socialMediaScores: [
      { platform: 'Instagram', score: 85, rationale: 'High engagement rates on product showcases and lifestyle content, particularly with the 25-35 demographic. Visual platform aligns well with our product design emphasis.' },
      { platform: 'YouTube', score: 75, rationale: 'Strong performance on tutorial and behind-the-scenes content. Educational videos about product features receive significant watch time.' },
      { platform: 'TikTok', score: 65, rationale: 'Growing presence with potential for viral content, particularly when highlighting product innovation. Currently underutilized but showing promising engagement metrics.' },
  ...
  '2': {
    ...
    socialMediaScores: [
      { platform: 'Instagram', score: 45, rationale: 'Limited appeal for industrial products, though facility tours and behind-the-scenes content shows some engagement. Not aligned with primary audience.' },
      { platform: 'YouTube', score: 80, rationale: 'Strong performance with technical demonstrations, case studies, and educational content about industrial processes and sustainability initiatives.' },
      { platform: 'TikTok', score: 25, rationale: 'Very limited relevance for industrial B2B marketing. Experimental presence only with minimal engagement metrics.' },
      { platform: 'Facebook', score: 60, rationale: 'Moderate engagement with industry news and corporate announcements. Useful for targeted advertising to specific business demographics.' },
      { platform: 'LinkedIn', score: 95, rationale: 'Primary social channel with excellent engagement on industry thought leadership, technical white papers, and recruitment. Key platform for B2B lead generation.' },
      { platform: 'WhatsApp', score: 30, rationale: 'Used primarily for internal communications and limited client service channels. Not a significant marketing platform.' },
      { platform: 'Snapchat', score: 10, rationale: 'Minimal relevance for industrial B2B marketing. No active presence or strategic value identified.' }
    ]
  },
  '3': {
    id: '3',
    ...
    socialMediaScores: [
      { platform: 'Instagram', score: 70, rationale: 'Good engagement with product lifestyle photography and tech culture content. Works well for building brand personality and reaching younger demographics.' },
      { platform: 'YouTube', score: 85, rationale: 'Excellent performance with product demonstrations, tutorials, and thought leadership discussions. High watch time and subscription conversion rates.' },
      { platform: 'TikTok', score: 75, rationale: 'Strong growth with short-form tech tips, behind-the-scenes development content, and tech humor reaching new audiences effectively.' },
      { platform: 'Facebook', score: 50, rationale: 'Moderate engagement primarily with older demographics. Useful for community management and customer support but limited organic reach.' },
      { platform: 'LinkedIn', score: 85, rationale: 'Valuable for B2B marketing, recruitment, and establishing thought leadership in AI and technology domains. Good lead generation performance.' },
      { platform: 'WhatsApp', score: 35, rationale: 'Limited direct marketing application, though showing promise for personalized customer support and beta testing communication channels.' },
      { platform: 'Snapchat', score: 55, rationale: 'Moderate relevance for reaching younger demographics with AR product experiences and quick feature announcements. Growing engagement metrics.' }
    ]
  }
};
    ...
    <MainLayout>
      <div className="space-y-8">
        ...
        <div className="space-y-4 pb-6 border-b">
          ...
          <div className="space-y-4">
            {clientDetails.socialMediaScores
